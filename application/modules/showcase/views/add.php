...
<div class="panel text-center panel-danger">
  ...
  <form action="" method="POST" enctype="multipart/form-data" class="form-horizontal">
    <div class="form-group">
      ...
      <div class="col-sm-9">
        <input type="text" name="showcase_title" class="form-control" required="required" value="<?= set_value('showcase_title')?>">
      </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9">
        <input type="text" name="showcase_price" class="form-control" required="required" value="<?= set_value('showcase_price')?>">
      </div>
      <div class="clearfix"></div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9">
        <textarea name="showcase_content" class="form-control" id="edit" cols="30" rows="10" required="required"><?= set_value('showcase_content')?></textarea>
      </div>
      <div class="clearfix"></div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9">
        <input type="file" name="showcase_thumb" required="required">
      </div>
      <div class="clearfix"></div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9">
        <input type="file" name="showcase_image" accept="image" required="required">
      </div>
      <div class="clearfix"></div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9">
        <button name="add_showcase" class="btn btn-primary">Add ShowCase</button>
      </div>
      <div class="clearfix"></div>
    </div>
  </form>
