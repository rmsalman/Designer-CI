...
<div class="panel text-center panel-danger">
  ...
  <form action="<?= base_url('blogs/edit/'.$this->uri->segment(3)); ?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
    <div class="form-group">
      ...
      <div class="col-sm-9">
        <input type="text" name="blog_title" class="form-control" required="required" value="<?= $blog->blog_title; ?>">
      </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9">
        <textarea name="blog_content" class="form-control" id="edit" cols="30" rows="10" required="required"><?= $blog->blog_content; ?></textarea>
      </div>
      <div class="clearfix"></div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9">
        <input type="file" name="blog_thumb" required="required" value="<?= $blog->blog_thumb; ?>">
      </div>
      <div class="clearfix"></div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9">
        <input type="file" name="blog_image" accept="image" required="required" value="<?= $blog->blog_thumb; ?>">
      </div>
      <div class="clearfix"></div>
    </div>
