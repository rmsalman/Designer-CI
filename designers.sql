...
CREATE TABLE `mailbox` (
  `id` int(11) NOT NULL,
  `send-from` int(200) NOT NULL,
  `send-to` int(200) NOT NULL,
  `title` text NOT NULL,
  `message` text NOT NULL,
  `created-at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated-at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP
...
CREATE TABLE `orders` (
  `id` int(11) NOT NULL,
  `plan-id` int(11) NOT NULL,
  `order-title` varchar(200) NOT NULL,
  `user-id` int(200) NOT NULL,
  `admin-id` int(200) NOT NULL,
  `designer-id` int(200) NOT NULL,
  `user-notes` text NOT NULL,
  `admin-notes` text NOT NULL,
  `designer-notes` text NOT NULL,
  `admin-attachment` varchar(200) NOT NULL,
  `user-attachment` varchar(200) NOT NULL,
  `designer-attachment` text NOT NULL,
  `user-status` int(10) NOT NULL,
  `admin-status` int(10) NOT NULL,
  `admin-status-to-designer` int(10) NOT NULL,
  `designer-status` int(10) NOT NULL,
  `field-1` text NOT NULL,
  `field-2` text NOT NULL,
  `field-3` text NOT NULL,
  `field-4` text NOT NULL,
  `field-5` text NOT NULL,
  `field-6` text NOT NULL,
  `field-7` text NOT NULL,
  `field-8` text NOT NULL,
  `field-9` text NOT NULL,
  `field-10` text NOT NULL,
  `created-at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated-at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
